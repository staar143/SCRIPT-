...
local Window = OrionLib:MakeWindow({Name = "Gear Hub br", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Gear Hub br"})
...
W:AddLabel("[+] Gear Hub br is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Gear Hub br(Noitification)",
